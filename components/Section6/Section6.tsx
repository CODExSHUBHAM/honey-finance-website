...
function Section6(): JSX.Element {
  return (
    <div className="bg-white bg-opacity-95 py-10 px-2">
      <Box className="py-8 px-2 bg-gray-50 flex flex-col text-center items-center">
        ...
        <div className="flex flex-col w-fit pt-8 gap-8">
