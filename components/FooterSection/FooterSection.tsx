...
function FooterSection(): JSX.Element {
  return (
    <div className="bg-white px-1 py-16 md:p-20">
      <div className="flex flex-col md:flex-row items-center text-center md:text-left w-fit mx-auto md:gap-40">
        <div>
          <Heading
            size="sm"
            variant="black"
            className="font-bold md:text-3xl md:w-[34rem]"
          >
        ...
        <div className="md:flex items-center justify-center md:w-[50rem]">
          <Box
            shadowType="DARK"
            className="py-6 px-2 flex flex-col items-center text-center md:w-[40rem]"
          >
            <Image src={Logo} alt="Honey Logo" />
            <Heading size="sm" variant="black" className="font-bold pt-3">
              Honey DAO
            </Heading>
            <p className="font-mono text-sm font-normal leading-5 text-gray-400 pt-4">
